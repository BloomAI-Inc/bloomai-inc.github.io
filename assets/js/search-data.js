    ...
    handler: () => {
      window.location.href = "/";
        ...
        handler: () => {
            ...
            window.location.href = "/blog/2026/topic-modelling/";
          
        },
      },{id: "post-llm-tester-your-ultimate-model-evaluation-studio",
        ...
        handler: () => {
            ...
            window.location.href = "/blog/2026/LLM-Tester-Your-Ultimate-Model-Evaluation-Studio/";
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%69%6E%66%6F@%62%6C%6F%6F%6D%61%69.%63%6F", "_blank");
        },
      },{
        id: 'social-whatsapp',
        title: 'whatsapp',
        section: 'Socials',
        handler: () => {
          window.open("https://wa.me/+1 704 620 2886", "_blank");
        },
      },{
        id: 'social-x',
        title: 'X',
        section: 'Socials',
        handler: () => {
          window.open("https://twitter.com/BloomAI2", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
